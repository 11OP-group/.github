...
7. Далее переходим во вкладку `Процессор`, где проверяем стоит ли у нас 2 ядра, а также ставим галочку напротив пункта `PAE/NX` \
    ![alt text](images/image-6.png)
8. Переходим в раздел `Носители`. Там, если уже что-то есть, удаляем, нажам ПКМ, а потом `Del`
    ![alt text](images/image-7.png)
9. Чуть ниже ищем пункт `Добавить контроллер` и добавляем AHCI(SATA)
    ![alt text](images/image-8.png)
10. Теперь добавляем оптический диск
